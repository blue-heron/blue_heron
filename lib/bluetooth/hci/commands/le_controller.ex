defmodule Bluetooth.HCI.Command.LEController do
  ...
  * OGF: `#{inspect(@ogf, base: :hex)}`
  ...
  def list() do
    ...
    |> Enum.filter(
      &match?(["Bluetooth", "HCI", "Command", "LEController", _mod], Module.split(&1))
    )
  end
  ...
  defmacro __using__(opts) do
    quote location: :keep, bind_quoted: [opts: opts] do
      ...
      use Bluetooth.HCI.Command, Keyword.put(opts, :ogf, LEC.__ogf__())

      @ocf ocf
      @opcode Bluetooth.HCI.Command.opcode(LEC.__ogf__(), @ocf)
