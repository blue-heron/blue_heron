defmodule Bluetooth.HCI.Command.LinkPolicy do
  ...
  * OGF: `#{inspect(@ogf, base: :hex)}`
  ...
  def list() do
    ...
    |> Enum.filter(&match?(["Bluetooth", "HCI", "Command", "LinkPolicy", _mod], Module.split(&1)))
  end
  ...
  defmacro __using__(opts) do
    quote location: :keep, bind_quoted: [opts: opts] do
      ...
      use Bluetooth.HCI.Command, Keyword.put(opts, :ogf, LP.__ogf__())

      @ocf ocf
      @opcode Bluetooth.HCI.Command.opcode(LP.__ogf__(), @ocf)
