defmodule Bluetooth.HCI.Event.LEMeta do
  ...
  def list() do
    ...
    |> Enum.filter(&match?(["Bluetooth", "HCI", "Event", "LEMeta", _mod], Module.split(&1)))
  end
    ...
    quote location: :keep, bind_quoted: [opts: opts] do
      subevent_code =
        Keyword.get_lazy(opts, :subevent_code, fn ->
          raise ":subevent_code key required when defining Bluetooth.HCI.Event.LEMeta.__using__/1"
        end)

      use Bluetooth.HCI.Event, code: LEMeta.__code__()
