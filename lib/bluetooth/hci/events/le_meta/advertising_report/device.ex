defmodule Bluetooth.HCI.Event.LEMeta.AdvertisingReport.Device do
  @moduledoc """
  ...
  The `:data` field of an `Bluetooth.HCI.Event.LEMeta.AdvertisingReport.Device` struct represents AD
  Structures.
  ...
  alias Bluetooth.HCI.{ArrayedData, Event.LEMeta.AdvertisingReport.Device}
  alias Bluetooth.{DataType.ManufacturerData}
  ...
  @doc """
  Serializes a list of `Bluetooth.HCI.Event.LEMeta.AdvertisingReport` structs into a LE Advertising
  Report Event.
  ...
  @doc """
  Serializes a `Bluetooth.HCI.Event.LEMeta.AdvertisingData.Device` structs' `:data` field into AD
  Structures.
