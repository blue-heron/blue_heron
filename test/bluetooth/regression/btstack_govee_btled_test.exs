...
defmodule BluetoothRegressionTest do
  ...
  describe "HCI_EVENT_PACKET" do
    test "1597079476.759177" do
      ...
      expected = %Bluetooth.HCI.Event.CommandComplete{
        code: 14,
      ...
      assert(
        Bluetooth.HCI.Serializable.serialize(actual) == binary,
        """
    ...
    test "1597079476.836986" do
      ...
      expected = %Bluetooth.HCI.Event.CommandStatus{
        code: 15,
        num_hci_command_packets: 2,
        opcode: "\r ",
        status: 0,
    ...
    test "1597079476.854206" do
      ...
      expected = %Bluetooth.HCI.Event.LEMeta.ConnectionComplete{
        code: 62,
    ...
    test "1597079477.803651" do
      ...
      expected = %Bluetooth.HCI.Event.DisconnectionComplete{
        code: 5,
        connection_handle: 16,
        reason: 22,
  ...
  describe "ACL Data" do
    test "1597079476.854508" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.ExchageMTURequest{client_rx_mtu: 1691, opcode: 2}
        },
        flags: %{bc: 0, pb: 0},
        handle: 16
      }
    ...
    test "1597079476.904050" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.ExchageMTUResponse{opcode: 3, server_rx_mtu: 23}
        },
        flags: %{bc: 0, pb: 0},
        handle: 528
      }
    ...
    test "1597079476.904085" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.ReadByGroupTypeRequest{
            ending_handle: 65535,
            opcode: 16,
            starting_handle: 1,
            uuid: 10240
    ...
    test "1597079476.963102" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.ReadByGroupTypeResponse{
            attribute_data: [
              %Bluetooth.ATT.ReadByGroupTypeResponse.AttributeData{
                end_group_handle: 7,
                handle: 1,
                uuid: 6144
              },
    ...
    test "1597079477.142685" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.ErrorResponse{
    ...
    test "1597079477.142742" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.ReadByTypeRequest{
            ending_handle: 7,
            opcode: 8,
            starting_handle: 1,
            uuid: 10243
    ...
    test "1597079477.202705" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.ReadByTypeResponse{
            attribute_data: [
              %Bluetooth.ATT.ReadByTypeResponse.AttributeData{
    ...
    test "1597079477.652780" do
      ...
      expected = %Bluetooth.ACL{
        data: %Bluetooth.L2Cap{
          cid: 4,
          data: %Bluetooth.ATT.WriteCommand{
